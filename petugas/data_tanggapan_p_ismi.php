        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" aria-current="page" href="petugas_ismi.php">Data Pengaduan</a>
                    <a class="nav-link active" aria-current="page" href="data_tanggapan_p_ismi.php">Data Tanggapan</a>
