...
if (isset($_POST['daftar'])) {
    ...
    if ($query && $query2) {
        echo "<script>alert('Berhasil menanggapi!');document.location.href='data_tanggapan_p_ismi.php';</script>";
    } else {
        echo "<script>alert('Gagal menanggapi!');document.location.href='petugas_ismi.php';</script>";
    }
}
