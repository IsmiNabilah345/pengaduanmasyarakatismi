        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link active" aria-current="page" href="petugas_ismi.php">Data Pengaduan</a>
                    <a class="nav-link" aria-current="page" href="data_tanggapan_p_ismi.php">Data Tanggapan</a>
                    <a class="nav-link" style="margin-left: 37.9rem;" href="../logout_ismi.php">Logout</a>
                </div>
            </div>
        </div>
    </nav><br>
            ...
            <tbody>
                <?php foreach ($role as $row) : ?>
                    <tr>
                        ...
                        <td><?php
                            if ($row['status_ismi'] == "0") {
                                echo "<a href='detail_p_ismi.php?id=$row[id_pengaduan_ismi]'>Belum Proses</a>";
                        ...
                        <td>
                            ...
                            if ($row['status_ismi'] === 'proses') {
                                echo "<a href='form_tanggapi_p_ismi.php?id=$row[id_pengaduan_ismi]'>Beri Tanggapan</a>";
                            } elseif ($row['status_ismi'] === 'selesai') {
                                echo "";
