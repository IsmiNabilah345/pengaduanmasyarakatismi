...
<body>
    ...
    ?>
    <h2 style="margin-bottom: 5px;">Pemerintahan Kota Cimahi</h2>
    <br>
    <h4 style="margin-bottom: 5px;">Data Tanggapan Pengaduan Masyarakat</h4>
    <h5>Kecamatan Cimahi Tengah</h5>
    <!-- <?php echo $label ?> -->
    <hr>
...
$pdf->WriteHTML($html);
$pdf->Output('Data Tanggapan Pengaduan Masyarakat.pdf', 'I');
?>